...
import { getReplayEvents, reconstructCodeFromEvents, } from "../services/leetcodeService";
/**
...
export const getReplay = asyncHandler(async (req, res) => {
    ...
    const events = await getReplayEvents(String(contestSlug).trim(), String(questionSlug).trim(), String(username).trim());
